...
const newFailProofPickImage = `  const handlePickImage = async () => {
    ...
    try {
      ...
      // ⏳ Hold AI Scanning Modal for 2.0 seconds so user sees full laser scan & dynamic steps!
...
content = content.replace(
  ...
  newFailProofPickImage
);

fs.writeFileSync(file, content, 'utf8');
console.log('✅ Updated handlePickImage in ScanScreen.tsx so it NEVER gets stuck!');
