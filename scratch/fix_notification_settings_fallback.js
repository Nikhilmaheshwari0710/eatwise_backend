...
const DEFAULT_FALLBACK_SETTINGS: SettingCategoryGroupApi[] = [
  {
    settingId: 'set_001',
    category: 'Health & Nutrition Alerts',
    items: [
      { key: 'high_sugar_alert', label: 'High Sugar Alerts', description: 'Get notified when a product has high sugar content', enabled: true },
      { key: 'high_sodium_alert', label: 'High Sodium Alerts', description: 'Get notified when a product has high sodium content', enabled: true },
      { key: 'harmful_additives_alert', label: 'Harmful Additives', description: 'Alerts for artificial colors, preservatives, MSG etc.', enabled: true },
    ],
  },
  {
    settingId: 'set_002',
    ...
    items: [
      { key: 'weekly_report_ready', label: 'Weekly Report Ready', description: 'Notify when weekly health report is generated', enabled: true },
      { key: 'monthly_report_ready', label: 'Monthly Report Ready', description: 'Notify when monthly health report is generated', enabled: false },
    ],
  },
  {
    settingId: 'set_003',
    ...
    items: [
      { key: 'growth_milestone', label: 'Growth Milestones', description: 'Celebrate height and weight milestone achievements', enabled: true },
    ],
  },
];
...
export const NotificationSettingsScreen: React.FC<NotificationSettingsScreenProps> = ({
  ...
  const [settingsGroups, setSettingsGroups] = useState<SettingCategoryGroupApi[]>(DEFAULT_FALLBACK_SETTINGS);
...
console.log('✅ Updated NotificationSettingsScreen.tsx with default fallbacks!');
